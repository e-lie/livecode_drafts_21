...
m1 >> pstrings(P[0,None,2,1,None]+[0,[0,2],[(0,2),-2],2,0], dur=cascara, oct=P[4,5,4], sus=.7, amp=P[.3,1]*2, vol=1)
m2 >> pstrings(P[None,1,None,1,0]+[0,[0,2],[(0,2),-2],2,0], dur=cascara, oct=P[4,5,4]+1, sus=.7, amp=P[.3,1], vol=1, cutoff=linvar([.2,1],128))
